...
public class DefaultApiController implements DefaultApi {
    ...
    public ResponseEntity<Userdata> getUserdataModel() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Userdata>(objectMapper.readValue("{  \"firstName\" : \"firstName\",  \"lastName\" : \"lastName\",  \"gender\" : \"gender\",  \"referenceNumber\" : \"referenceNumber\",  \"dateOfBirth\" : \"dateOfBirth\",  \"postCode\" : \"postCode\",  \"PK\" : 0,  \"City\" : \"City\",  \"concernRoleId\" : 6}", Userdata.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<Void> rootPost(@ApiParam(value = ""  )  @Valid @RequestBody Userdata userdata) {
        String accept = request.getHeader("Accept");
